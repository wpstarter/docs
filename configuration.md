...
After placing the application in maintenance mode, you may navigate to the application URL matching this token and WpStarter will issue a maintenance mode bypass cookie to your browser:
